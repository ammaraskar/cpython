...
oss_getptr(oss_audio_t *self, PyObject *unused)
{
    ...
    {
    PyObject* _tupleMember0;
    _tupleMember0 = PyLong_FromLong(info.bytes);
    PyTuple_SET_ITEM(_builtResult, 0, _tupleMember0);
    }
    {
    PyObject* _tupleMember1;
    _tupleMember1 = PyLong_FromLong(info.blocks);
    PyTuple_SET_ITEM(_builtResult, 1, _tupleMember1);
    }
    {
    PyObject* _tupleMember2;
    _tupleMember2 = PyLong_FromLong(info.ptr);
    PyTuple_SET_ITEM(_builtResult, 2, _tupleMember2);
    }
    }
...
oss_mixer_get(oss_mixer_t *self, PyObject *args)
{
    ...
    {
    PyObject* _tupleMember0;
    _tupleMember0 = PyLong_FromLong(volume & 0xff);
    PyTuple_SET_ITEM(_builtResult, 0, _tupleMember0);
    }
    {
    PyObject* _tupleMember1;
    _tupleMember1 = PyLong_FromLong((volume & 0xff00) >> 8);
    PyTuple_SET_ITEM(_builtResult, 1, _tupleMember1);
    }
    }
