...
rlimit2py(struct rlimit rl)
{
    if (sizeof(rl.rlim_cur) > sizeof(long)) {
        ...
        _builtResult2_tupleMember0 = PyLong_FromLongLong((long long) rl.rlim_cur);
        ...
        _builtResult2_tupleMember1 = PyLong_FromLongLong((long long) rl.rlim_max);
    ...
    _builtResult1_tupleMember0 = PyLong_FromLong((long) rl.rlim_cur);
    ...
    _builtResult1_tupleMember1 = PyLong_FromLong((long) rl.rlim_max);
