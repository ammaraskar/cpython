...
PyCData_reduce(PyObject *myself, PyObject *args)
{
    ...
    _builtResult1_tupleMember1_tupleMember1 = PyTuple_New(2);
    if (_builtResult1_tupleMember1_tupleMember1 == NULL) {
        goto _builtResult1_tupleMember1_tupleMember1_cleanup;
    }
    {
    PyObject* _builtResult1_tupleMember1_tupleMember1_tupleMember0;
    PyObject* _objectArg = (PyObject*) dict;
    if (_objectArg) {
        _builtResult1_tupleMember1_tupleMember1_tupleMember0 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult1_tupleMember1_tupleMember1_tupleMember0 = NULL;
    }
    if (_builtResult1_tupleMember1_tupleMember1_tupleMember0 == NULL) {
        Py_CLEAR(_builtResult1_tupleMember1_tupleMember1);
        goto _builtResult1_tupleMember1_tupleMember1_cleanup;
    }
    PyTuple_SET_ITEM(_builtResult1_tupleMember1_tupleMember1, 0, _builtResult1_tupleMember1_tupleMember1_tupleMember0);
    }
    {
    PyObject* _builtResult1_tupleMember1_tupleMember1_tupleMember1;
    PyObject* _objectArg = (PyObject*) PyBytes_FromStringAndSize(self->b_ptr, self->b_size);
    if (_objectArg) {
        _builtResult1_tupleMember1_tupleMember1_tupleMember1 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult1_tupleMember1_tupleMember1_tupleMember1 = NULL;
    }
    if (_builtResult1_tupleMember1_tupleMember1_tupleMember1 == NULL) {
        Py_CLEAR(_builtResult1_tupleMember1_tupleMember1);
        goto _builtResult1_tupleMember1_tupleMember1_cleanup;
    }
    PyTuple_SET_ITEM(_builtResult1_tupleMember1_tupleMember1, 1, _builtResult1_tupleMember1_tupleMember1_tupleMember1);
    }
    _builtResult1_tupleMember1_tupleMember1_cleanup: ;
    if (_builtResult1_tupleMember1_tupleMember1 == NULL) {
        Py_CLEAR(_builtResult1_tupleMember1);
        goto _builtResult1_tupleMember1_cleanup;
    }
