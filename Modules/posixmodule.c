...
/*[clinic end generated code: output=98841ce5ec9cef3c input=f3d99fd99e762907]*/
{
    ...
    _builtResult1_tupleMember0 = PyLong_FromLong(master_fd);
    ...
    _builtResult1_tupleMember1 = PyLong_FromLong(slave_fd);
...
/*[clinic end generated code: output=60d0a5c7512e4087 input=f1f7f4bae3966010]*/
{
    ...
    PyObject* _objectArg = (PyObject*) PyLong_FromPid(pid);
    if (_objectArg) {
    ...
    _builtResult2_tupleMember1 = PyLong_FromLong(master_fd);
...
#undef SET_INT
    ...
    _builtResult3_tupleMember1 = PyLong_FromLong(status);
    ...
    if (_objectArg) {
        _builtResult3_tupleMember2 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult3_tupleMember2 = NULL;
    }
...
/*[clinic end generated code: output=5c37c06887a20270 input=0bf1666b8758fda3]*/
{
    ...
    PyObject* _objectArg = (PyObject*) PyLong_FromPid(res);
    if (_objectArg) {
    ...
    _builtResult4_tupleMember1 = PyLong_FromLong(WAIT_STATUS_INT(status));
...
/*[clinic end generated code: output=6bc419ac32fb364b input=03b0182d4a4700ce]*/
{
    ...
    _builtResult5_tupleMember1 = PyLong_FromLong(WAIT_STATUS_INT(status));
...
# define OFF_T_MAX 0x7fffffffffffffff
    ...
    if (offobj == Py_None) {
        ...
        _builtResult7 = PyLong_FromSsize_t(ret);
        #else
        _builtResult7 = PyLong_FromLong(ret);
        #endif
        }
    ...
    {
    #if SIZEOF_SIZE_T!=SIZEOF_LONG
    _builtResult6 = PyLong_FromSsize_t(ret);
    #else
    _builtResult6 = PyLong_FromLong(ret);
    #endif
    }
...
/*[clinic end generated code: output=ff9b76255793b440 input=02535e8c8fa6c4d4]*/
{
    ...
    _builtResult8_tupleMember0 = PyLong_FromLong(fds[0]);
    ...
    _builtResult8_tupleMember1 = PyLong_FromLong(fds[1]);
...
/*[clinic end generated code: output=25751fb43a45540f input=f261b6e7e63c6817]*/
{
    ...
    _builtResult9_tupleMember0 = PyLong_FromLong(fds[0]);
    ...
    _builtResult9_tupleMember1 = PyLong_FromLong(fds[1]);
...
/*[clinic end generated code: output=9ad3a11bfb4f4bd2 input=3d6d826b76d8a34e]*/
{
    ...
    if (getloadavg(loadavg, 3)!=3) {
        ...
        _builtResult10_tupleMember0 = PyFloat_FromDouble(loadavg[0]);
        ...
        _builtResult10_tupleMember1 = PyFloat_FromDouble(loadavg[1]);
        ...
        _builtResult10_tupleMember2 = PyFloat_FromDouble(loadavg[2]);
...
/*[clinic end generated code: output=8e0becff5dece5bf input=41ccfa8e1f6517ad]*/
{
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromUid(ruid);
    if (_objectArg) {
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromUid(euid);
    if (_objectArg) {
        _builtResult11_tupleMember1 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult11_tupleMember1 = NULL;
    }
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromUid(suid);
    if (_objectArg) {
        _builtResult11_tupleMember2 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult11_tupleMember2 = NULL;
    }
...
/*[clinic end generated code: output=2719c4bfcf27fb9f input=517e68db9ca32df6]*/
{
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromGid(rgid);
    if (_objectArg) {
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromGid(egid);
    if (_objectArg) {
        _builtResult12_tupleMember1 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult12_tupleMember1 = NULL;
    }
    ...
    PyObject* _objectArg = (PyObject*) _PyLong_FromGid(sgid);
    if (_objectArg) {
        _builtResult12_tupleMember2 = _objectArg;
    } else {
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_SystemError, "NULL object passed to Py_BuildValue");
        }
        _builtResult12_tupleMember2 = NULL;
    }
